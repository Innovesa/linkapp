                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form role="form" name="frmMantenimientoPersonas" id="frmMantenimientoPersonas" action="{{route('entidades.personas.create')}}" enctype="multipart/form-data" method="POST">
                                @csrf
...
<script src="{{ Module::asset('Entidades:js/personas/personas.js') }}"></script>
@endsection